# Contributing to scala-api-boilerplate

Love scala-api-boilerplate and want to help? Thanks so much, there's something to do for everybody!
...
The [issue tracker](https://github.com/faeldon/scala-api-boilerplate/issues) is
...
1. [Fork](https://help.github.com/articles/fork-a-repo/) the project, clone your fork, and configure the remotes:
   ...
   git clone https://github.com/<your-username>/scala-api-boilerplate.git
   # Navigate to the newly cloned directory
   cd scala-api-boilerplate
   # Assign the original repo to a remote called "upstream"
   git remote add upstream https://github.com/faeldon/scala-api-boilerplate.git
   ```
...
owners to license your work under the terms of the [MIT License](https://github.com/faeldon/scala-api-boilerplate/blob/master/LICENSE.md).
