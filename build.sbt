...
// Microsite settings
git.remoteRepo := "git@github.com:faeldon/scala-api-boilerplate.git"

micrositeGithubOwner := "jafaeldon"

micrositeGithubRepo := "scala-api-boilerplate"

micrositeName := "Scala API Boilerplate"

micrositeDescription := "API Boilerplate in Scala"

micrositeBaseUrl := "/scala-api-boilerplate"
